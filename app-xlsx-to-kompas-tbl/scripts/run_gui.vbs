...
launcherExe = fso.BuildPath(appRoot, "bin\app-xlsx-to-kompas-tbl.exe")
guiScript = fso.BuildPath(appRoot, "scripts\gui_import.ps1")
...
If Not fso.FileExists(guiScript) Then
    MsgBox "gui_import.ps1 not found: " & guiScript, vbCritical, "xlsx-to-kompas-tbl app"
    WScript.Quit 2
End If
